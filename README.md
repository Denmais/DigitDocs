...
> **Статус:** прикладной проект. README содержит места для рисунков, скриншотов интерфейса и схем. Замените заглушки на реальные изображения из проекта.
...
> Ниже оставлены места под изображения. Рекомендуется хранить картинки в директории `docs/images`.
...
> Реальная структура может отличаться. При необходимости обновите дерево проекта под фактические файлы.
